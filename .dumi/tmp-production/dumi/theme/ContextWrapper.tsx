...
// Static content
const pkg = {"name":"youtil","description":"油梯，一个与框架、环境无关的小巧、精简、实用的JavaScript工具库","version":"3.1.7","license":"MIT","repository":{"type":"git","url":"github.com/sxei/youtil"},"author":"sxei"};
